...
const instructors = [
  {
    ...
    rank: "FAIXA PRETA",
    desc: "Faixa-preta com ampla experiência no ensino do Jiu-Jitsu, reconhecido pela didática clara e pela formação de alunos técnicos e disciplinados. Especialista no desenvolvimento de fundamentos sólidos, estratégia e evolução constante dentro e fora do tatame.",
    img: "/images/mestre-silmar-silva.jpg"
  },
  {
    name: "Alessandro Jacob",
    role: "Professor de Jiu-Jitsu",
    rank: "FAIXA MARROM",
    desc: "Faixa-marrom com grande dedicação ao aperfeiçoamento técnico e à formação de atletas. Conhecido pelo treinamento intenso e atenção aos detalhes, ajudando alunos a evoluírem com segurança, técnica refinada e mentalidade competitiva.",
    img: "/images/programa-avancado.jpg"
  },
  {
    name: "Professor de Muay Thai",
    role: "Instrutor de Muay Thai",
    rank: "INSTRUTOR",
    desc: "Instrutor especializado em Muay Thai com foco em condicionamento físico, técnica de combate e disciplina. Suas aulas combinam tradição, intensidade e evolução progressiva, proporcionando treinos dinâmicos e eficientes para todos os níveis.",
    img: "/images/programa-nogi.jpg"
  }
];
              ...
              <div className="bg-[#101122] rounded-2xl overflow-hidden border border-[#0d20f2]/20 flex flex-col md:flex-row">
                ...
                <div className="md:w-2/3 p-8 md:p-12 flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-slate-500 text-sm">Faixa Preta</span>
                  </div>
                  <h3 className="text-4xl font-bold mb-2">Silmar Silva</h3>
